...
| 项目 | 固定提交 | 采用的参考点 |
| --- | --- | --- |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | `82a5fd61a7cf5c293cec4bdff68f455398d685e9` | DSH CLI、Web Gateway、新版 journal/session event、审批/问题、alpha.2 认证与图片请求管线和运行时约束 |
