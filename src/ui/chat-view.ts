  ...
  <div id="app" class="app is-loading">
    ...
    <section id="settings-dialog" class="settings-dialog hidden" aria-label="DeepSeek Harness settings">
      ...
      <div class="settings-body">
        ...
        <section id="settings-automation" class="settings-section"><h3>Automation</h3><label class="settings-check"><input id="setting-schedule-enabled" type="checkbox"><span>Enable scheduled follow-ups</span></label><p class="settings-note">The official dsh-schedule plugin exposes schedule_create, schedule_list, and schedule_delete to the model. When enabled, the extension also gives the first prompt a short reminder to use these tools instead of pwsh/bash sleep. Reminders are session-local; an armed reminder keeps the Pause control available so you can cancel it. Changing this setting restarts the local Harness runtime.</p></section>
    ...
    <div class="session-toolbar"><nav id="session-tabs" class="session-tabs" role="tablist" aria-label="DeepSeek Harness sessions"></nav><button id="fold-all" class="icon-button" title="Collapse details in the running task" aria-label="Collapse details in the running task"><i data-lucide="fold-vertical"></i></button><button id="expand-all" class="icon-button" title="Expand details in the running task" aria-label="Expand details in the running task"><i data-lucide="unfold-vertical"></i></button><button id="search-conversation" class="icon-button" title="Search current session" aria-label="Search current session"><i data-lucide="search"></i></button></div>
      ...
      <div id="composer-box" class="composer-box">
        ...
        <div class="composer-bottom">
          ...
          <div class="composer-right">
            ...
            </span></button><button id="compact-menu" class="icon-button split-arrow" title="Compaction, folding, and context settings" aria-label="Compaction, folding, and context settings" aria-expanded="false"><i data-lucide="chevron-down"></i></button><div id="compact-popover" class="popover align-right hidden" role="menu"><div class="menu-heading">Compaction model</div><div id="compact-model-options" class="menu-options"></div><button id="auto-fold-running" class="menu-option" role="menuitem" aria-pressed="false"><i data-lucide="fold-vertical"></i><span class="menu-option-copy"><span class="menu-option-label">Auto-fold running task</span><span class="menu-option-description">Keep live reasoning and tool details folded while the task runs; completed tasks stay open</span></span></button><button id="configure-context" class="menu-option" role="menuitem"><i data-lucide="settings-2"></i><span class="menu-option-copy"><span class="menu-option-label">Context settings</span><span class="menu-option-description">Capacity and automatic threshold</span></span></button></div></div>
