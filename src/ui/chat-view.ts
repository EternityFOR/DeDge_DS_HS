  ...
  <div id="app" class="app is-loading">
    ...
    <section id="settings-dialog" class="settings-dialog hidden" aria-label="DeepSeek Harness settings">
      ...
      <div class="settings-body">
        ...
        <section id="settings-automation" class="settings-section"><h3>Automation</h3><label class="settings-check"><input id="setting-schedule-enabled" type="checkbox"><span>Enable scheduled follow-ups</span></label><p class="settings-note">The official dsh-schedule plugin exposes schedule_create, schedule_list, and schedule_delete to the model. When enabled, the extension also gives the first prompt a short reminder to use these tools instead of pwsh/bash sleep. Reminders are session-local; changing this setting restarts the local Harness runtime.</p></section>
